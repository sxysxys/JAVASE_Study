...
public class Wildcards {
    ...
    static void rawArgs(Holder holder, Object arg) {
        holder.set(arg);    //这里不会错，因为编译器会直接取消泛型，这时候相当于参数变成了Object。也就是放弃了编译器管理类型。
    ...
    public static void main(String[] args) {
        ...
        Long r6 = exact2(qualified, lng);   //只能用这种形式传值，把T给确定了，不能让两个参数分别有不同的T。



        //lng弄进去不一定是Long，会综合判断，有时候会识别成Object。由于传参和形参的方向一致，所以能赋值。
